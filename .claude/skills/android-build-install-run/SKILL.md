...
description: Build, install, launch, and smoke-check the latest Android app build on a connected device or emulator for this repository. Use when validating device-visible behavior, reproducing acceptance criteria on hardware, or preparing a clean APK install before manual or automated Android verification.
---
...
- the main session asks for install-and-verify evidence before advancing a feature
