...
class DeveloperOverlayTimingTest {

    @Test
    fun overlayBecomesVisibleWithinOneSecondAfterDeveloperModeEnabled() {
        SettingsDependencies.settingsRepositoryProvider = { OverlayTimingSettingsRepository() }
    ...
    @Test
    fun overlayBecomesGoneWithinOneSecondAfterDeveloperModeDisabled() {
        SettingsDependencies.settingsRepositoryProvider = { OverlayTimingSettingsRepository() }
        launchFragmentInContainer<SettingsFragment>(
            themeResId = com.google.android.material.R.style.Theme_Material3_DayNight_NoActionBar,
        ).use {
...
private class OverlayTimingSettingsRepository : NdiSettingsRepository {
