...
public sealed class PermissionAppiumDriverFixture : AppiumDriverFixture
{
    ...
    /// dialog. Dismissing it here, once, before any test runs, gives every test a known starting
    /// point; each test still does its own revoke-then-restart cycle regardless of what this
    /// leaves behind.
    /// </summary>
