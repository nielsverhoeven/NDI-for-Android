...
name: maui.expert
description: >
  .NET MAUI knowledge resource for this project. Answers questions from other agents
  on how to correctly implement features using .NET MAUI. Consults official Microsoft
  and dotnet documentation. Use when another agent needs authoritative guidance on
  MAUI APIs, patterns, platform specifics, or best practices. Do NOT use for general
  C# questions unrelated to MAUI.
tools:
  - read
  - search
  - web
handoffs:
  - label: Update Architecture
    agent: architect
    prompt: The MAUI expert has provided new or updated technology guidance. Review and incorporate it into the architecture and constitution if it affects technology choices or standards.
    send: false
  - label: Return to Orchestrator
    agent: orchestrator
    prompt: MAUI guidance has been provided. Resume the feature pipeline with this information.
    send: false
---
