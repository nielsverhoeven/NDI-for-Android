...
| Reusable NDI render surface | `src/MauiApp/Features/Viewer/Views/ViewerView.xaml(.cs)` (SkiaSharp; draw-on-arrival via `ViewerViewModel.FrameReady`, with a 33 ms fallback pull — #416) |
